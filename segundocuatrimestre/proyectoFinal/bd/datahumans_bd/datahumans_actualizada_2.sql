...
--
-- Host: localhost    Database: datahumans_probando
-- ------------------------------------------------------
...
CREATE TABLE `caracteristicaspuesto` (
  ...
  KEY `fk_carat_vacante_idx` (`id_vacantes`),
  CONSTRAINT `fk_carat_vacante` FOREIGN KEY (`id_vacantes`) REFERENCES `vacantes` (`id_vacantes`)
...
-- Dump completed on 2024-10-23 23:10:46
